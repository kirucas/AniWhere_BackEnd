            ...
            <div class="nav-link">
                <div class="user-wrapper">
                    <div class="profile-image">
                        <img src="<c:url value='/resources/assets/images/faces/face1.jpg' />" alt="profile image">
                    </div>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="dashboard-dropdown">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="<c:url value='/' />">Dashboard 1</a>
                    </li>
                    <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/ui-features/lazy-load.html">Lazy Load</a>
                    </li>
                </ul>
            </div>
        </li>
