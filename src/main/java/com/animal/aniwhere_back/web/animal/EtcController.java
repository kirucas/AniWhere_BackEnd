...
public class EtcController {
	...
	@ResponseBody
	@RequestMapping(value = "/etc/photo_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/etc/movie_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/etc/tip_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/etc/quest_delete.awa", produces="text/plain; charset=UTF-8")
