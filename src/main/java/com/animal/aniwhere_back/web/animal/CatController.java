...
public class CatController {
	...
	@ResponseBody
	@RequestMapping(value = "/cat/photo_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/cat/movie_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/cat/tip_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/cat/quest_delete.awa", produces="text/plain; charset=UTF-8")
