...
public class RnaController {
	...
	@ResponseBody
	@RequestMapping(value = "/rna/photo_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/rna/movie_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/rna/tip_delete.awa", produces="text/plain; charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/rna/quest_delete.awa", produces="text/plain; charset=UTF-8")
